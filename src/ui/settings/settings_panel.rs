...
impl SettingsPanel {
    ...
    fn keybind_columns() -> (Vec<Line<'static>>, Vec<Line<'static>>) {
        ...
        let left = vec![
            ...
            keybind("x", "Toggle pause"),
            keybind("v", "Stop playback"),
            keybind("n / p", "Next / previous track"),
            keybind(", / .", "Seek backward / forward 5s"),
            ...
            keybind("g/G Home/End", "Jump first / last"),
        ...
        let right = vec![
            ...
            keybind("k / Up", "Move up"),
            keybind("PageUp / PageDown", "Move by page"),
            keybind("g/G Home/End", "Jump first / latest log"),
